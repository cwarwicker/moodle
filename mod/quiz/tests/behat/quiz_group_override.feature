...
Feature: Quiz group override
  ...
  Background:
    Given the following "users" exist:
      ...
      | student4 | Sam 4      | Student 4 | student4@example.com |
  ...
  @javascript
  Scenario: Quiz activity group override applied correctly for student within visible group
    Given the following "mod_quiz > group overrides" exist:
      | quiz      | group | password |
      | Test quiz | G1    | owl      |
    When I am on the "Test quiz" "mod_quiz > View" page logged in as "student1"
    ...
    And I should not see "To attempt this quiz you need to know the quiz password"

  @javascript
  Scenario: Quiz activity group override applied correctly for student within hidden group
    Given the following "mod_quiz > group overrides" exist:
      | quiz      | group | password |
      | Test quiz | G4    | owl      |
    When I am on the "Test quiz" "mod_quiz > View" page logged in as "student4"
    Then I should see "To attempt this quiz you need to know the quiz password"
    And I am on the "Test quiz" "mod_quiz > View" page logged in as "student2"
    And I should not see "To attempt this quiz you need to know the quiz password"
