...
class stored_progress_bar extends \progress_bar {
    ...
    /** @var int|null Message to associate with bar */
    protected $message = null;

    /** @var int|null Time last polled for progress */
    protected $timelastpolled = null;
     ...
     * @return void
     */
    protected function _update($percent, $msg): void {
        global $OUTPUT;
    ...
    /**
     * Get the current timestamp in the format we want.
     *
     * @return int
     */
     ...
     * @param int $id ID of an object from database, e.g. 123
