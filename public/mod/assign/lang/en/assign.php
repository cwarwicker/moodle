...
$string['allownotifycontrol'] = 'Allow graders to control whether students receive notifications when graded';
$string['allownotifycontrol_help'] = 'This toggles the ability for graders to check/uncheck the "Notify student" option when grading a student\'s submission.';
