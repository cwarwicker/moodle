...
$string['invalidmarkerallocation:'] = 'Invalid marker allocation';
...
$string['multimarkrounding_help'] = 'If using a marking agreement method which requires calclations (e.g. "average"), how should rounding be done in the cases where the result is not a whole number?';
