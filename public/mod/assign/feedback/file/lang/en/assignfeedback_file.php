...
$string['markerfiles'] = 'Marker files';
$string['markerfile1'] = 'Marker {$a} file';
...
$string['uploadcontext'] = 'Upload context';
$string['uploadcontext:grade'] = 'Apply the feedback files to the overall grade for the submission.';
$string['uploadcontext:mark'] = 'Apply the feedback files to your mark, where you are an allocated marker.';
