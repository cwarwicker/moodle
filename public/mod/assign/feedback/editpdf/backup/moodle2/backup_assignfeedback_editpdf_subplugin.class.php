...
class backup_assignfeedback_editpdf_subplugin extends backup_subplugin {
    ...
    protected function define_grade_subplugin_structure() {
        ...
        $subpluginelementmarkerfiles = new backup_nested_element('feedback_editpdf_marker_files', null, array('markid'));
        ...
        $subpluginelementmarkerfiles->set_source_sql('SELECT id AS markid from {assign_mark} where gradeid = :gradeid', array('gradeid' => backup::VAR_PARENTID));
        ...
        $subpluginelementmarkerfiles->annotate_files('assignfeedback_editpdf', \assignfeedback_editpdf\document_services::FINAL_PDF_FILEAREA_MARKER, 'markid');
